  ...
  const getRankStyles = (index: number) => {
    switch (index) {
      ...
      default: return { 
        ...
        text: "text-slate-500", 
        icon: <span className="text-sm font-mono font-bold text-slate-600">#{index + 1}</span>,
        glow: ""
      };
    }
  };
      ...
      <div className="max-w-5xl mx-auto p-6 md:p-12">
        ...
        <div className="text-center mb-12 space-y-4">
          ...
          <p className="text-slate-400 text-lg max-w-2xl mx-auto">
            Recognizing the top performers. Compete, earn XP, and climb the ranks.
          </p>
        </div>
        ...
        <div className="relative z-50 flex flex-col md:flex-row gap-4 mb-8 justify-between items-center bg-[#0b1021] p-5 rounded-2xl border border-slate-800 shadow-2xl">
          ...
          <div className="flex items-center gap-2 text-slate-400">
            ...
            <span className="text-sm font-bold uppercase tracking-wider text-slate-500">Filters</span>
          </div>
        ...
        <div className="relative z-0 bg-[#0b1021] border border-slate-800 rounded-3xl overflow-hidden shadow-2xl">
          ...
          {topUsers === undefined ? (
            ...
            <div className="p-20 text-center flex flex-col items-center gap-4">
              ...
              <div>
                <p className="text-lg text-white font-medium">No students found</p>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="col-span-2 md:col-span-1 flex justify-center">
                        <div className={`w-8 h-8 flex items-center justify-center rounded-full ${index < 3 ? 'bg-slate-900/50 border border-slate-700' : ''}`}>
                            {style.icon}
                        </div>
                    </div>
                    ...
                    <div className="col-span-3 text-right pr-2 md:pr-4">
                      <p className={`font-mono font-bold text-lg md:text-xl tracking-tighter ${index < 3 ? style.text : 'text-white'}`}>
                        {user.currentXP.toLocaleString()}
                      </p>
                      <p className="text-[10px] font-bold text-slate-600 uppercase tracking-widest">XP</p>
                    </div>
