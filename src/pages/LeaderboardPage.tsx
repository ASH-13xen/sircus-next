    ...
    <div className="min-h-screen bg-[#020617] text-white p-6 font-sans">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-10 space-y-2">
          <h1 className="text-4xl font-extrabold text-transparent bg-clip-text bg-linear-to-r from-yellow-400 to-orange-500">
            Hall of Fame
          </h1>
              ...
              <div
                ...
                className={`flex items-center justify-between p-5 border-b border-slate-800/50 hover:bg-slate-800/40 transition-colors ${
                  index === 0
                    ...
                    : index === 1
                      ? "bg-slate-500/10 border-l-4 border-l-slate-400"
                      : index === 2
                        ? "bg-orange-500/10 border-l-4 border-l-orange-600"
                        : ""
                }`}
              >
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    ...
                    <div className="flex gap-3 text-xs text-slate-400 mt-1 font-medium">
                      ...
                      {user.branch && (
                        <span className="px-2 py-0.5 bg-slate-800 rounded text-blue-300">
                          {user.branch}
                        </span>
                      )}
                      {user.collegeYear && (
                        <span className="px-2 py-0.5 bg-slate-800 rounded text-green-300">
