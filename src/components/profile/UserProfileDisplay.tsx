      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-5xl mx-auto space-y-8">
          ...
          {(userData.branch || isOwner) && (
            <div
              className={`border rounded-2xl p-6 shadow-lg relative overflow-hidden transition-colors ${
                isMissingInfo && isOwner
            ...
            >
              ...
              <div className="flex justify-between items-start mb-6">
                <div>
                  <h3
                    className={`text-lg font-bold flex items-center gap-2 ${isMissingInfo && isOwner ? "text-yellow-500" : "text-slate-200"}`}
                  >
                    {isMissingInfo && isOwner ? (
              ...
              {!isEditing ? (
                ...
                <div className="bg-slate-900/80 p-6 rounded-xl border border-slate-700">
                  <div className="mb-4 bg-yellow-500/10 border border-yellow-500/20 p-3 rounded text-sm text-yellow-200 flex gap-2">
                    ...
                    <p>
                      <strong>Caution:</strong> Academic details can only be
                      changed <strong>once</strong> after setting. Please ensure
