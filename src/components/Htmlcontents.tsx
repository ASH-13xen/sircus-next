...
const topicContent: TopicContentMap = {
  "Overview of HTML": (
    <>
      <p className="mb-4">
        ...
        describing the structure of documents displayed on the web. HTML
        consists of a series of elements and attributes which are used to mark
        up all the components of a document to structure it in a meaningful way.
      </p>
      <p className="mb-4">
        ...
        embedding images and form controls.
      </p>
      ...
      <p className="mb-4">
        ...
        certain way. HTML elements are delineated by tags, written using angle
      ...
      <div className="bg-slate-900 p-4 border-l-4 border-teal-500 my-4 text-slate-300">
        ...
        <code>&lt;h1&gt;</code> tag. The actual title, Machine Learning
        Workshop, is the content of our element.
      </div>
      ...
      <div className="my-6">
        ...
        <div className="w-full max-w-3xl h-64 bg-slate-900 rounded border border-slate-700 flex items-center justify-center text-slate-500">
          [Diagram of HTML Element Structure: Opening Tag + Content + Closing
          Tag]
        </div>
      </div>

      <p className="mb-4">
        Elements and tags are not the exact same thing, though many people use
  ...
  content</p>`}</pre>
      ...
      <p className="mb-4">
        Browsers do not display the tags. The tags are used to interpret the
        content of the page.
      </p>
    </>
  ),
  ...
  "Document Structure": (
    <>
      <p className="mb-4">
        HTML documents include a document type declaration and the{" "}
        <code>&lt;html&gt;</code> root element. Nested in the{" "}
        <code>&lt;html&gt;</code> element are the document head and document
        body.
      </p>
      <h2 className="text-teal-400 text-2xl font-bold mt-8 mb-4">
        Add to every HTML document
      </h2>
      <p className="mb-4">
        There are several features that should be considered essential for any
        and every web page.
      </p>
      ...
      <p>
        The first thing in any HTML document is the preamble. It tells the
        browser to use standards mode.
      </p>
    </>
  ),
  ...
  Metadata: (
    <p>
      Metadata provides information about the HTML document like the title,
      character set, author, and viewport settings, usually inside the{" "}
      <code>&lt;head&gt;</code> tag.
    </p>
  ),
  ...
  "Semantic HTML": (
    <p>
      Semantic HTML uses meaningful tags like <code>&lt;article&gt;</code>,{" "}
      <code>&lt;section&gt;</code>, <code>&lt;header&gt;</code>, and{" "}
      <code>&lt;footer&gt;</code> to describe the content’s purpose and
      structure.
    </p>
  ),
  ...
  Attributes: (
    <p>
      Attributes provide additional information about HTML elements, such as id,
      class, href, and src.
    </p>
  ),
  "Text Basics": (
    <p>
      Basic text formatting tags include paragraphs, line breaks, emphasis, and
      strong importance.
    </p>
  ),
  Links: (
    <p>
      Links are created using the anchor tag, allowing users to navigate between
      pages.
    </p>
  ),
  ...
  Forms: (
    <p>
      Forms collect user input with elements like input, textarea, and buttons.
    </p>
  ),
  Images: <p>Images are embedded with the img tag and can include alt text.</p>,
  "Audio and Video": (
    <p>
      HTML5 provides native multimedia support through audio and video tags.
    </p>
  ),
  "Template, Slot, and Shadow": (
    <p>Templates define reusable HTML fragments.</p>
  ),
  "HTML APIs": (
    <p>
      HTML APIs provide programmatic interfaces to enhance web functionality.
    </p>
  ),
  Focus: <p>Focus management controls which element is active.</p>,
  "Other Inline Text Elements": (
    <p>Inline elements like span, code, mark, sub, and sup.</p>
  ),
  "Details and Summary": (
    <p>The details and summary elements create expandable sections.</p>
  ),
  Dialog: (
    <p>The dialog element provides native support for modal dialog boxes.</p>
  ),
  "Conclusion and Next Steps": (
    <p>This section summarizes key HTML concepts covered.</p>
  ),
};
