...
const CybersecuritytopicContent: Record<string, TopicData> = {
  "What is Cybersecurity": {
    title: "What is Cybersecurity",
    content:
      "Cybersecurity is the practice of protecting systems, networks, and programs from digital attacks. It's an essential defense mechanism encompassing technologies, processes, and controls designed to secure data and infrastructure from malicious threats.",
    subheadings: {
  ...
  "Protecting Your Data and Identity": {
    ...
    content:
      "This addresses the personal steps you must take to secure your digital life and prevent unauthorized access to your private information.",
    subheadings: {
  ...
  "Data Location and Smart Devices": {
    ...
    content:
      "Understanding where your data resides and the specific threats posed by modern connected technology.",
    subheadings: {
      "Where is Your Data": [
  ...
  "Cyber Attacker Motives and Threats": {
    ...
    content:
      "A look at who is attacking digital systems and their primary motivations, ranging from financial to political.",
    subheadings: {
  ...
  "Organizational Security": {
    ...
    content:
      "The complexities of protecting a business or institution, including various data types and threat origins.",
    subheadings: {
  ...
  "Cyber Attacker Classifications": {
    ...
    content:
      "A system used to categorize attackers based on their intent, morality, and legality.",
    subheadings: {
      "The Hat System": [
  ...
  "Protection Strategies": {
    ...
    content:
      "The technical and procedural steps required to implement robust security across devices, networks, and organizations.",
    subheadings: {
  ...
  "Legal and Ethical Frameworks": {
    ...
    content:
      "The complex landscape of laws and moral obligations that govern the practice of cybersecurity.",
    subheadings: {
      "Legal Issues": [
        ...
        {Cybersecuritytopics.map((topic) => {
          ...
          return (
            ...
            >
              ...
              {Object.entries(contentData.subheadings).map(
                ([subheadingTitle, points]) => (
                  <div
                    key={subheadingTitle}
